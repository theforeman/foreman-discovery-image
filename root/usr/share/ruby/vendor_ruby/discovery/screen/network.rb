def screen_network mac, vlan_id, ip = cmdline('fdi.pxip', ''), gw = cmdline('fdi.pxgw', ''), dns = cmdline('fdi.pxdns', '')
  ...
  t_ip = Newt::Entry.new(16, 8, ip.to_s, 55, Newt::FLAG_SCROLL)
  t_gw = Newt::Entry.new(16, 10, gw.to_s, 55, Newt::FLAG_SCROLL)
  t_dns = Newt::Entry.new(16, 12, dns.to_s, 55, Newt::FLAG_SCROLL)
